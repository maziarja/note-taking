...
function DesktopCreateNewNote() {
  ...
  return (
    <form action={handleCreateNewNoteAction} className="grid">
      <div className="mb-4 border-b-1 border-neutral-200">
        <textarea
          name="title"
          placeholder="Enter a title..."
          className="text-preset-1 field-sizing-content w-full resize-none text-neutral-950 outline-0 sm:text-[24px]"
          required
        />
        <div className="mb-3 flex flex-col gap-3 border-b border-neutral-200 py-4">
          <div className="grid grid-cols-[1fr_2fr] sm:grid-cols-[1fr_4fr]">
            <div className="flex gap-[6px]">
              ...
              <p className="text-preset-5 text-neutral-700 sm:text-[14px]">
                Tags
              </p>
            </div>
            <div className="flex gap-[2px]">
              <textarea
                required
                name="tags"
                className="text-preset-5 w-full resize-none text-neutral-700 outline-0 sm:text-[14px]"
                type="text"
          ...
          <div className="grid grid-cols-[1fr_2fr] items-center sm:grid-cols-[1fr_4fr]">
            ...
            <input
              disabled
              className="text-preset-5 text-neutral-700 outline-0 sm:text-[14px]"
              type="text"
        ...
        <textarea
          required
          name="content"
          className="text-preset-5 field-sizing-content h-[572px] w-full resize-none whitespace-pre-line text-neutral-700 outline-0 sm:text-[14px]"
          type="text"
      ...
      <div className="flex items-start gap-4">
        <button className="text-preset-4 cursor-pointer rounded-lg bg-blue-500 px-4 py-3 text-[#fff]">
...
export default DesktopCreateNewNote;

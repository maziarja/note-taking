...
function Navigation() {
  ...
  const searchParam = searchParams.get("from");
  const darkMode = useTheme();
  return (
    <div className="bg-neutral-0 fixed bottom-0 flex w-full items-center justify-center border-t border-neutral-200 px-4 py-3 shadow-[0_0_8px_0.5px_rgba(0,0,0,0.1)]">
      <Link
        href={"/"}
        className={`flex grow-1 items-center justify-center rounded-sm border-r-1 border-neutral-100 py-1 sm:flex-col sm:gap-1 ${(searchParam || pathname).endsWith("/") && `${darkMode ? "bg-neutral-100" : "bg-neutral-700"}`}`}
      >
        <svg
        ...
        <p
          className={`text-preset-6 hidden sm:block ${(searchParam || pathname).endsWith("/") ? "text-blue-500" : "text-neutral-600"}`}
        >
          Home
        </p>
      </Link>
      <Link
        href={"/search"}
        className={`flex grow-1 items-center justify-center rounded-sm border-r-1 border-neutral-100 py-1 sm:flex-col sm:gap-1 ${pathname.endsWith("/search") && `${darkMode ? "bg-neutral-100" : "bg-neutral-700"}`}`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
        ...
        >
          <path
            className={
              (searchParam || pathname).startsWith("/search")
                ? "fill-blue-500"
                : "fill-neutral-600"
            }
            fillRule="evenodd"
        ...
        <p
          className={`text-preset-6 hidden sm:block ${(searchParam || pathname).startsWith("/search") ? "text-blue-500" : "text-neutral-600"}`}
        >
          Search
        </p>
      </Link>
      <Link
        href={"/archive"}
        className={`flex grow-1 items-center justify-center rounded-sm border-r-1 border-neutral-100 py-1 sm:flex-col sm:gap-1 ${(searchParam || pathname).startsWith("/archive") && `${darkMode ? "bg-neutral-100" : "bg-neutral-700"}`}`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
        ...
        >
          <path
            className={
              (searchParam || pathname).startsWith("/archive")
                ? "stroke-blue-500"
                : "stroke-neutral-600"
            }
            strokeLinecap="round"
        ...
        <p
          className={`text-preset-6 hidden sm:block ${(searchParam || pathname).startsWith("/archive") ? "text-blue-500" : "text-neutral-600"}`}
        >
          Archived
        </p>
      </Link>
      <Link
        href={"/tags"}
        className={`flex grow-1 items-center justify-center rounded-sm border-r-1 border-neutral-100 py-1 sm:flex-col sm:gap-1 ${pathname.startsWith("/tags") && `${darkMode ? "bg-neutral-100" : "bg-neutral-700"}`}`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
        ...
        >
          <path
            className={
              (searchParam || pathname).startsWith("/tags")
                ? "stroke-blue-500"
                : "stroke-neutral-600"
            }
            strokeLinecap="round"
        ...
        <p
          className={`text-preset-6 hidden sm:block ${(searchParam || pathname).startsWith("/tags") ? "text-blue-500" : "text-neutral-600"}`}
        >
          Tags
        </p>
      </Link>
      <Link
        href={"/settings"}
        className={`flex grow-1 items-center justify-center rounded-sm py-1 sm:flex-col sm:gap-1 ${pathname.startsWith("/settings") && `${darkMode ? "bg-neutral-100" : "bg-neutral-700"}`}`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
        ...
        >
          <path
            className={
              (searchParam || pathname).startsWith("/settings")
                ? "fill-blue-500"
                : "fill-neutral-600"
            }
            fillRule="evenodd"
        ...
        <p
          className={`text-preset-6 hidden sm:block ${pathname.startsWith("/settings") ? "text-blue-500" : "text-neutral-600"}`}
        >
          Settings
        </p>
      </Link>
